...
subplot(4,3,6)
plot(t,si, 'LineWidth', 1.5, 'Color', 'r'); ylabel('si', 'fontsize', 14); hold on
...
suptitle(['Starvation shock, period = ', num2str(tperiod), 'min'])

fig_name = sprintf('starvation_shock_%s_period.png', num2str(tperiod));
